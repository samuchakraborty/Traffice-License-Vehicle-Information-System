...
class StolenVehicleList extends StatefulWidget {
  const StolenVehicleList({Key? key}) : super(key: key);

  @override
  _StolenVehicleListState createState() => _StolenVehicleListState();
}

class _StolenVehicleListState extends State<StolenVehicleList> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Stolen Vehicle List"),
        centerTitle: true,
      ),
      body: Container(

...
class SSL extends StatefulWidget {
  @override
  _SSLState createState() => _SSLState();
}

class _SSLState extends State<SSL> {
  ...
  Future<void> sslCommerzGeneralCall() async {
    Sslcommerz sslcommerz = Sslcommerz(
        initializer: SSLCommerzInitialization(
            ...
            store_id: "samu60277edaca972",
            store_passwd: "samu60277edaca972@ssl",
            total_amount: 10,
